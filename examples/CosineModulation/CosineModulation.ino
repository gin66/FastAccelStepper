...
void setup() {
  ...
  Serial.println("");
  Serial.println("Depending on your motor and current setting, the stepper may stop spinning at high speed");
...
uint16_t count = 0;
uint32_t dt_const;
const uint8_t cos_tab[64] = {
	0, 2, 9, 21, 37, 56, 79, 103, 127, 152, 176, 199, 218, 234, 246, 253, 256, 253, 246, 234, 218, 199, 176, 152, 128, 103, 79, 56, 37, 21, 9, 2
};
