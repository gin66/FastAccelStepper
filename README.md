...
* The turn on delay is min `MIN_DELTA_TICKS` for avr or `MIN_CMD_TIME` for esp32.
...
* avr: two steppers run in parallel generate too many steps starting from approx 2kStep/s
