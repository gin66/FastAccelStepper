...
"""seq_07c: Single direction move, verify final position @20.

Steps:
  1. Attach pulse counter p7
  2. Move +20 steps at 40 us/step, accel 1000
  3. Wait for completion
  4. Expected final position: 20
"""
...
try:
    with SerialSession(DEVICE, motor=MOTOR, log_file=LOG) as s:
        ...
        s.send(f"{MOTOR} p7,-32767,32767 V40 A1000 R20 W")

        s.wait_for(rf">> {MOTOR}: @20 \[20\]")
    print("PASS")
