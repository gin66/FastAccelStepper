...
"""seq_01a: Forward run, force stop, two moves, verify final position @1100.

Steps:
  1. Attach pulse counter p7
  2. Run forward at 25000 steps/s, accel 10000
  3. After 1 s, force-stop, clear counter
  4. Move +100 steps, wait, then +1000 steps
  5. Expected final position: 1100
"""
