...
class FastAccelStepperTest {
 public:
  ...
  void ramp(TestCase tc) {
    printf(
        "Running ramp test with forward_planning=%d, position=%d, speed_us=%d, "
        "acceleration=%d\n",
...
#define MAX_STEPS 100000
    ...
    test(steps == tc.position,
         "number of steps does not match target position");
