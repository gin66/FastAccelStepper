...
class FastAccelStepper {
 public:
  ...
  // The delay from enable to first step is done in ticks and as such limited to ABSOLUTE_MAX_TICKS,
  // which translates approximately to 1s (for esp32 and avr at 16 MHz).
