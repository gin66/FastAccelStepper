...
class FastAccelStepper {
 public:
  ...
  // to ABSOLUTE_MAX_AQE_TICKS, which translates approximately to 120ms for esp32
  // and 60ms for avr at 16 MHz). The delay till disable is done in period interrupt/task
